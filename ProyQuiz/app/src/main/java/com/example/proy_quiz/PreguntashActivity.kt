...
class PreguntashActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Nombre=intent.getStringExtra(setDatah.nombre)
        val usuario=intent.getStringExtra(setDatah.nombre)
       // f_nombre.text="${usuario}, marca la opción correcta"
        //setData.getPregunta()


        preguntasList=setDatah.getPreguntah()
        setPregunta()
            ...
            if (selectOpc!=0){
                ...
                when{
                    currentPosition<=preguntasList!!.size->{
                        ...
                        intent.putExtra(setDatah.nombre,Nombre.toString())
                        intent.putExtra(setDatah.score,score.toString())
